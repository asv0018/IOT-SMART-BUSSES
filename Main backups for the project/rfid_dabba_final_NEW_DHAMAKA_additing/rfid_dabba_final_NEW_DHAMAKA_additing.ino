  ...
  switch(var)
{
  ...
  case 'B':
  lcd.clear();
  Serial.println("B is pressed \n this opens addition of students program");
  while(1){
    pseudoloopAdding();
  }
  break;
...
//Serial.println("place the id card");
  ...
  // Check is the PICC ogf Classic MIFARE type
...
void pseudoloopAdding()
 {
  //lol this loop does nothing!.
 }
